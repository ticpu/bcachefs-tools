...
128-bit ancestor bitmap for O(1) checks within 128 snapshot IDs, plus a
randomized skiplist of three ancestor IDs for O(log $n$) convergence on
deeper trees. During early
